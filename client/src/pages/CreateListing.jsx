...
export default function CreateListing() {
      ...
      try {
        ...
        for (let i = 0; i < files.length; i++) {
          ...
          if (file.size > maxSize) {
            setImageUploadError('Each image should be less than 5MB');
            continue;
          }
        ...
        setImageUploadError('Error processing images. Please try again.');
      } finally {
        setUploading(false);
      }
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/listing/create`, {
        method: 'POST',
        headers: {
  ...
  return (
    <main className='min-h-screen bg-gray-50 py-8'>
      <div className='max-w-4xl mx-auto px-4'>
        <h1 className='text-3xl font-semibold text-center text-gray-800 mb-8'>Create Listing</h1>
